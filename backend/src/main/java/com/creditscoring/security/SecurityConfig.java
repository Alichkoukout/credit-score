...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Use origin patterns to support random localhost ports used by Flutter/Web dev
        // servers
        ...
        configuration.setAllowCredentials(false); // we use JWT in headers, no cookies needed
